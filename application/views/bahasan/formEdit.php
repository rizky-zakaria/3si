<div class="card bg-light mb-3" style="max-width: 100%;">
    ...
    <form action="<?= base_url("BahasanRapat/editData"); ?>" method="post">
        ...
        <div class="form-group ml-3 mr-3">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="bahasan" required><?= $bahasan['bahasan']; ?></textarea>
            <input type="hidden" name="id" value="<?= $bahasan['id']; ?>">
        </div>
        <center>
